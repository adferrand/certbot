...
from typing import Optional, cast, Tuple, Any, Callable
...
class ClientNetwork:
    ...
    """
    def __init__(self, key: josepy.JWK, account: Optional[messages.RegistrationResource] = None,
                 alg: josepy.JWASignature = jose.RS256, verify_ssl: bool = True,
    ...
    def _wrap_in_jws(self, obj: josepy.interfaces.JSONDeSerializable, nonce: str, url: str,
                     acme_version: int) -> josepy.JWS:
        ...
        kwargs["key"] = self.key
        return jws.JWS.sign(jobj, **kwargs).json_dumps(indent=2)  # type: ignore

    @classmethod
    def _check_response(cls, response: Response, content_type: Optional[str] = None) -> Response:
    ...
    def _send_request(self, method: str, url: Union[bytes, str],
    ...
    def get(self, url: str, content_type: str = JSON_CONTENT_TYPE, **kwargs: Any) -> Response:
        """Send GET request and check response."""
        return self._check_response(
            self._send_request('GET', url, **kwargs), content_type=content_type)

    def _add_nonce(self, response: Response) -> None:
    ...
    def _post_once(self, url: str, obj: josepy.interfaces.JSONDeSerializable,
...
class ClientBase:
    ...
    @classmethod
    def _regr_from_response(cls, response: Response, uri: Optional[str] = None,
    ...
    def _send_recv_regr(self, regr: messages.RegistrationResource,
                        body: messages.ResourceBody) -> messages.RegistrationResource:
    ...
    def update_registration(self, regr: messages.RegistrationResource,
                            update: Optional[bool] = None) -> messages.RegistrationResource:
        """Update registration.
    ...
    def _authzr_from_response(self, response: Response, identifier: Optional[str] = None,
    ...
    def answer_challenge(self, challb: messages.ChallengeBody,
                         response: Response) -> messages.ChallengeResource:
        """Answer challenge.
    ...
    @classmethod
    def retry_after(cls, response: Response, default: int) -> datetime.datetime:
    ...
    def _revoke(self, cert: josepy.util.ComparableX509, rsn: int, url: str) -> None:
        """Revoke certificate.
...
class Client(ClientBase):
    ...
    def __init__(self, directory: messages.Directory, key: josepy.JWK,
                 alg: josepy.JWASignature = josepy.RS256, verify_ssl: bool = True,
    ...
    def agree_to_tos(self, regr: messages.RegistrationResource) -> messages.RegistrationResource:
    ...
    def request_issuance(self, csr: josepy.util.ComparableX509,
    ...
    def poll(self, authzr: messages.AuthorizationResource
             ) -> Tuple[messages.AuthorizationResource, Response]:
    ...
    def _get_cert(self, uri: str) -> Tuple[Response, josepy.util.ComparableX509]:
    ...
    def fetch_chain(self, certr: messages.CertificateResource, max_length: int = 10
    ...
    def revoke(self, cert: josepy.util.ComparableX509, rsn: int) -> None:
        """Revoke certificate.
...
class ClientV2(ClientBase):
    ...
    def update_registration(self, regr: messages.RegistrationResource, update: Optional[bool] = None
                            ) -> messages.RegistrationResource:
        """Update registration.
    ...
    def _get_v2_account(self, regr: messages.RegistrationResource) -> messages.RegistrationResource:
        ...
        new_regr: messages.RegistrationResource = regr.update(uri=updated_uri)
    ...
    def _post_as_get(self, *args: Any, **kwargs: Any) -> Response:
        """
    ...
    def _get_links(self, response: Response, relation_type: str) -> List[str]:
        """
...
class BackwardsCompatibleClientV2:
    ...
    def __init__(self, net: ClientNetwork, key: josepy.JWK, server: str) -> None:
    ...
    def new_order(self, csr_pem: str):
        """Request a new Order object from the server.
